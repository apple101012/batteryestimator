...
Download the latest `BatteryUsage-1.0.2.pkg` from GitHub Releases, open it, and follow the installer.
...
- `dist/BatteryUsage-1.0.2.pkg`
- `dist/BatteryUsage-1.0.2.zip`
